...
提炼出 7 个核心心智模型、12 条决策启发式和一套表达 DNA，<br>
...
6 个研究文件，共 691 行，保存在 [`references/research/`](references/research/) 目录：

| 文件 | 内容 | 行数 |
|------|------|------|
| `01-writings.md` | 文章与公开表达分析，包括科技自媒体选题、AI 基础设施和开发者视角 | 111 |
| `02-conversations.md` | AI 对话、朋友聊天、CodeVibes 产品成熟度、技术栈、投资/量化和执行复盘 | 137 |
| `03-expression-dna.md` | 表达风格、常用句式、比喻系统、内容选题、投资表达和执行复盘方式 | 89 |
| `04-external-views.md` | 朋友、同僚/CEO、投资交流、AI 产品判断和工具执行反馈中的外部视角 | 113 |
| `05-decisions.md` | 关键决策记录，包括内容选题、CodeVibes 演进、技术栈、商业化、投资规则、执行边界、超级 App 和 AI 投资研究系统判断 | 183 |
| `06-timeline.md` | 当前阶段、项目经历、近期方向、AI 产品判断和工具执行校准时间线 | 58 |
...
- `sources/projects.txt`：项目方向材料，目前包含 AI 投资研究系统构想。
