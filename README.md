...
**一个产品型独立开发者的个人决策副驾驶。不是人格分析报告，是可运行的产品、内容、技术栈和投资学习判断框架。**

<br>

基于个人文章、AI 对话、朋友/同僚聊天和项目讨论材料蒸馏，<br>
提炼出 7 个核心心智模型、8 条决策启发式和一套表达 DNA，<br>
...
```text
Self Perspective > 先别急着做大平台，先把“持续治理入口”打透。
...
```text
Self Perspective > 追热点可以，但不能做纯新闻搬运。
...
```text
Self Perspective > 先别整体重写，按模块边界判断。
...
6 个研究文件，共 525 行，保存在 [`references/research/`](references/research/) 目录：

| 文件 | 内容 | 行数 |
|------|------|------|
| `01-writings.md` | 文章与公开表达分析，包括科技自媒体选题、AI 基础设施和开发者视角 | 111 |
| `02-conversations.md` | AI 对话、朋友聊天、CodeVibes 产品成熟度、技术栈和投资/量化讨论 | 89 |
| `03-expression-dna.md` | 表达风格、常用句式、比喻系统、内容选题和投资表达方式 | 83 |
| `04-external-views.md` | 朋友、同僚/CEO 和投资交流中的外部反馈 | 81 |
| `05-decisions.md` | 关键决策记录，包括内容选题、CodeVibes 演进、技术栈、商业化和投资规则 | 115 |
| `06-timeline.md` | 当前阶段、项目经历和近期方向时间线 | 46 |
